...
**相关概念**：[[ralph_loop_ai编程死循环模式|ralph_loop_ai编程死循环模式]], [[判断力_judgment|判断力_judgment]], [[ai作为高配实习生_角色分工方法论|ai作为高配实习生_角色分工方法论]], [[superpowers_ai编程纪律工具|superpowers_ai编程纪律工具]]
**关键人物**：[[andrej_karpathy_大牛_ai大牛|andrej_karpathy_大牛_ai大牛]]

# 🧠 Vibe Coding（凭感觉接受 LLM 输出的编程模式）

## 1. 定义与核心原理

Vibe Coding 由 [[andrej_karpathy_大牛_ai大牛|andrej_karpathy_大牛_ai大牛]] 在 2025 年 2 月 X 推文中提出，原文定义：
...
2026 年 Sequoia AI Ascent 上 Karpathy 宣布 vibe coding 已不再是他的主流姿势——升级为 [[agentic_engineering_调度智能体的工程范式|agentic_engineering_调度智能体的工程范式]]：
...
- **教学场景争议**：vibe coding 让初学者快速出活，但是否削弱编程基础认知仍有争议（与 [[判断力_judgment|判断力_judgment]] 关联）
