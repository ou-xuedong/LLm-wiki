...
Boris 认为模型早已具备编写 100% 代码的能力，编码问题实际上已被解决。这与 [[andrej_karpathy_大牛_ai大牛|andrej_karpathy_大牛_ai大牛]] 的判断互为印证。
...
3. **投资领域知识**：在 [[判断力_judgment|判断力_judgment]] 和垂直领域专业知识上建立不可替代性
